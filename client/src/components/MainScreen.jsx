...
//useState to check if character has been created
    ...
    console.log(characterSet);
     return (!characterSet ? <div className="screen-inner-container"> <NewSimScreen setCharacterSet={setCharacterSet} setCharacter={setCharacter} setFamilyName={setFamilyName} familyName={familyName}/> </div>: (<div className="screen-inner-container"><MenuBar currentYear={currentYear} setCurrentYear={setCurrentYear} allYearlyEvents={allYearlyEvents} addNewEvent={addNewEventToScreen}/><div className="yearly-event-screen"><ul className="event-list">{eventList.map((event) => (
